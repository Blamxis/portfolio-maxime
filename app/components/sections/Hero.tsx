export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.22]">
        ...
        >
          <defs>
            ...
            {/* PATTERN COMPLET QUI REMPLIT TOUT */}
            <pattern
              id="pcbPattern"
              width="300"
              height="300"
            ...
            >
              {/* Lignes organiques */}
              <path
                d="M20 40 H120 V80 H200 V140 H140 V200 H60"
                className="pcb-line"
              />
              <path d="M260 30 V110 H320 V170 H280" className="pcb-line" />
              <path
                d="M40 260 H140 V300 H220 V360 H160 V420 H80"
                className="pcb-line"
              />
              <path
                d="M100 500 H200 V540 H260 V600 H180"
                className="pcb-line"
              />
          ...
          {/* RECTANGLE QUI REMPLIT TOUT AVEC LE PATTERN */}
      ...
      {/* Contenu */}
      <div className="relative z-10 text-center px-4 translate-y-[-50px] md:translate-y-0">
        <p className="text-xs uppercase tracking-[0.3em] text-(--accent-soft) mb-3">
          Développeur Web — Futur Ingénieur Informatique
        </p>

        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-4">
          Développeur aujourd’hui. Ingénieur demain.
        </h1>

        <p className="text-sm md:text-base text-(--text-muted) max-w-xl mx-auto">
          Je conçois des projets modernes, j’améliore mes compétences chaque
          jour et je prépare ma reprise d’études dans le but de devenir
          ingénieur informatique. Découvrez mes réalisations, mon parcours et ma
          vision.
        </p>
